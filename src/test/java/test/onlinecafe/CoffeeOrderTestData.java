...
public final class CoffeeOrderTestData {
    ...
    public static CoffeeOrderDto getCoffeeOrder1Dto() {
        ...
        itemDtoList.add(new CoffeeOrderItemDto(COFFEE_TYPE1, 2, COFFEE_TYPE1.getPrice().multiply(new BigDecimal(2)), false));
        itemDtoList.add(new CoffeeOrderItemDto(COFFEE_TYPE4, 2, COFFEE_TYPE4.getPrice().multiply(new BigDecimal(2)), false));
        itemDtoList.add(new CoffeeOrderItemDto(COFFEE_TYPE5, 2, COFFEE_TYPE5.getPrice().multiply(new BigDecimal(2)), false));
